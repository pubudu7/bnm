...
* Added dynamic content width support.
* Fixed customizer control js issue.

= 1.0.8 =
* Fixed site title width issue.
...
- bnm_the_icon_svg()
- bnm_get_icon_svg()
- bnm_nav_menu_social_icons()

* Images shown in screenshot.
Image 1 shown in screenshot.png, Copyright Direct Media
...
License: CC0 1.0 Universal (CC0 1.0)
Source: https://stocksnap.io/photo/people-browsing-5TSIDK0IPJ
