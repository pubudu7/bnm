...
<div class="bnm-author-bio">
    ...
    <div class="bnm-author-content">
        <div class="bnm-author-name"><a href="<?php echo esc_url( get_the_author_meta( 'ID' ) ); ?>" rel="author"><?php echo esc_html( get_the_author() );?></a></div>
        <div class="bnm-author-description"><?php echo wp_kses_post( wpautop( get_the_author_meta( 'description' ) ) ); ?></div>
        <a class="bnm-author-link" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author">
            <?php
