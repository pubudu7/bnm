...
class BNM_Sidebar_Posts extends WP_Widget {

	/* Register Widget with WordPress*/
	function __construct() {
		parent::__construct(
			'bnm_sidebar_posts', // Base ID
			esc_html__( 'BNM: Sidebar Posts', 'bnm' ), // Name
			array( 'description' => esc_html__( 'Displays latest posts or posts from a choosen category.Use this widget in the main sidebars.', 'bnm' ), ) // Args
		);
	}
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'number_posts' ); ?>"><?php esc_html_e( 'Number of posts:', 'bnm' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('sticky_posts'); ?>"><?php esc_html_e( 'Ignore sticky posts.', 'bnm' ); ?></label>
		</p>
        <p>
...
function bnm_register_sidebar_posts() {
    register_widget( 'BNM_Sidebar_Posts' );
}
add_action( 'widgets_init', 'bnm_register_sidebar_posts' );