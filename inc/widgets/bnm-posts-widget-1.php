		...
		<div class="bnm-pws-1">
			...
			<?php 
				...
				while ( $latest_posts -> have_posts() ) : $latest_posts -> the_post();
					...
					<div class="bnms-posts">

				<?php } else { ?>

					<div class="bnms-post">
						<?php if ( has_post_thumbnail() ) { ?>
							<div class="bnms-thumb">
								<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail( 'bnm-thumbnail' ); ?></a>
							</div>
						<?php } ?>
						<div class="bnms-details">
							<?php the_title( sprintf( '<h3 class="bnms-entry-title"><a href="%s" rel="bookmark">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
