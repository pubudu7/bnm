wp.customize.controlConstructor['bnm-slider'] = wp.customize.Control.extend({
    ...
    ready: function() {
        ...
        var control             = this,
            ...
            rangeInput          = control.container.find( '.bnm-slider' ),
            textInput           = control.container.find( '.bnm-slider-text' ),
			resetBtn            = control.container.find( '.bnm-slider-reset' ),
